...
correct option shows a green success marker and unlocks **Next card**. This rule
is enforced in both the Flutter UI and the background callback, so the launcher
widget cannot skip a question.
